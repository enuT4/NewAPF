...
public class GlobalValue : MonoBehaviour
{
    ...
    public static int[] bonusUpgradeCost = new int[15] { 1300, 1800, 2400, 3100, 5000, 7000, 9000, 11000, 13000, 15000, 20000, 25000, 30000, 35000, 50000 };
    public static float[] feverAmount = new float[16];
    public static int[] feverUpgradeCost = new int[15] { 1500, 1900, 2500, 3300, 5500, 7700, 9900, 12500, 16000, 20000, 25000, 30000, 35000, 40000, 55000 };
    public static float[] superAmount = new float[16];
    public static int[] superUpgradeCost = new int[15] { 1000, 1500, 2200, 2900, 3800, 4900, 6200, 7500, 9000, 10000, 15000, 20000, 25000, 30000, 45000 };
    ...
    public static void YSMSUpgradeAmount()
    {
    ...
    public static void SDJRUpgradeAmount()
    {
